...
public class TntPLGame extends AbstractPageList {

    private final TntPlayer tntPlayer;

    public TntPLGame(PlayerBoard player, TntPlayer tntPlayer) {
        super(player);
    ...
    protected List<AbstractPage> createPages() {
        return List.of(new TntGamePage(this, this.tntPlayer));
    }

    public static class TntGamePage extends AbstractPage {
